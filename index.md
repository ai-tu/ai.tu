...
<header class="w3-container w3-top w3-hide-large w3-dark-gray w3-xlarge w3-padding" style="left:0">
...
<div class="w3-main" style="margin-left:200px;margin-right:10px">
  ...
  <div class="w3-container" id="Über uns" style="margin-top:50px">
    ...
    <p>AI.TU ist eine studentische Hochschulgruppe der Technischen Universität Berlin zu den Themen Künstliche Intelligenz und Machine Learning.</p>
    <p>
  ...
  <!-- Projekte -->
  <div class="w3-container" id="Projekte" style="margin-top:500px">
